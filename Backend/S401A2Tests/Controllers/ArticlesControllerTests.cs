...
namespace S401A2.Tests
{
    ...
    {
        private Mock<IDataRepository<Article>> _mockRepository;
        ...
        public void Setup()
        {
            _mockRepository = new Mock<IDataRepository<Article>>();
            _controller = new ArticlesController(_mockRepository.Object);
        }
