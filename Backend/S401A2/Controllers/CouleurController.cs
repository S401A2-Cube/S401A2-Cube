...
namespace S401A2.Controllers
{
    ...
    public class CouleursController : ControllerBase
    {
        ...
        public CouleursController(IDataRepository<Couleur> dataRepository)
        {
        ...
        public async Task<IEnumerable<Couleur>> GetCouleurs()
        {
        ...
        {
            var couleur = await _repository.GetByIdAsync(id);
        ...
        public async Task<IActionResult> PutCouleur(int id, Couleur couleur)
        {
            ...
            var couleurToUpdate = await _repository.GetByIdAsync(id);
            if (couleurToUpdate == null || couleurToUpdate == null)
            {
                return NotFound();
            }

            await _repository.UpdateAsync(couleurToUpdate, couleur);
        ...
        public async Task<IActionResult> DeleteCouleur(int id)
        {
            ...
            await _repository.DeleteAsync(couleur);
